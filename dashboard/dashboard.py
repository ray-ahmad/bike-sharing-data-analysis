...
with st.container():
    ...
    with st.expander("Lihat penjelasan..."):
        st.write("""Tren peminjaman sepeda cenderung meningkat sepanjang hari dengan puncaknya terjadi pada sore hari, seperti yang terlihat pada line chart di atas. Hal ini menunjukkan bahwa seiring berjalannya waktu dari pagi hingga malam, jumlah peminjaman sepeda secara umum mengalami peningkatan. Pada pagi hari, jumlah peminjaman sepeda masih relatif rendah, kemudian mulai meningkat secara signifikan saat siang dan mencapai puncaknya pada sore hari. Setelah sore hari, jumlah peminjaman sepeda cenderung mulai menurun menjelang malam hari. Hal ini mungkin disebabkan oleh perubahan aktivitas dan pola perjalanan pengguna, seperti perjalanan pulang kerja atau kegiatan rekreasi sore hari.""")